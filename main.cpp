...
void FindMAC(struct ether_addr *targ_mac, struct ether_addr atkr_mac, struct in_addr atkr_ip, struct in_addr targ_ip)
{
...
int main(int argc, char *argv[])
{
	...
	// Victim MAC address
	FindMAC(&vict_mac, atkr_mac, atkr_ip, vict_ip);
	printf("Victim MAC : %s\n", ether_ntoa(&vict_mac));

	// Gateway MAC address
	FindMAC(&gate_mac, atkr_mac, atkr_ip, gate_ip);
